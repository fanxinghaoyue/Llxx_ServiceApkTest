...
class ViewFetcher
{
    ...
    public View getTopParent(View view)
    {
        ...
        if (viewParent != null && viewParent instanceof android.view.View)
        {
    ...
    public float getScrollListWindowHeight(View view)
    {
        ...
        if (parent == null)
        {
            WindowManager windowManager = (WindowManager) instrumentation
                    .getTargetContext()
            ...
            Class<T> classToFilterBy, boolean includeSubclasses, View parent)
    {
        ...
        for (View view : allViews)
        {
            ...
            if (includeSubclasses
                    && classToFilterBy.isAssignableFrom(classOfView)
                    || !includeSubclasses && classToFilterBy == classOfView)
            {
    ...
    public View getRecyclerView(boolean shouldSleep, int recyclerViewIndex)
    {
        ...
        ArrayList<View> views = RobotiumUtils.filterViewsToSet(
                new Class[] { ViewGroup.class }, getAllViews(false));
    ...
    public List<View> getAllRecyclerViews(boolean shouldSleep)
    {
        ...
        @SuppressWarnings("unchecked")
        ArrayList<View> views = RobotiumUtils.filterViewsToSet(
                new Class[] { ViewGroup.class }, getAllViews(true));
        views = RobotiumUtils.removeInvisibleViews(views);
    ...
    public View getIdenticalView(View view)
    {
        ...
        List<? extends View> visibleViews = RobotiumUtils
                .removeInvisibleViews(getCurrentViews(view.getClass(), true));
    ...
    {
        if (firstView.getId() != secondView.getId() || !firstView.getClass()
                .isAssignableFrom(secondView.getClass()))
        {
            return false;
        }

        if (firstView.getParent() != null
                && firstView.getParent() instanceof View
                && secondView.getParent() != null
                && secondView.getParent() instanceof View)
        {

            return areViewsIdentical((View) firstView.getParent(),
                    (View) secondView.getParent());
        }
        else
        {
            return true;
