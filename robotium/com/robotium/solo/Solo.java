...
public class Solo
{
    ...
    private Solo(Config config, Instrumentation instrumentation,
            Activity activity)
    {

        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "Solo(" + config + ", "
                    + instrumentation + ", " + activity + ")");
        }

        this.config = (config == null) ? new Config() : config;
        this.instrumentation = instrumentation;
        this.sleeper = new Sleeper(config.sleepDuration,
                config.sleepMiniDuration);
        this.sender = new Sender(instrumentation, sleeper);
        this.activityUtils = new ActivityUtils(config, instrumentation,
                activity, sleeper);
        this.viewFetcher = new ViewFetcher(instrumentation, sleeper);
        this.screenshotTaker = new ScreenshotTaker(config, instrumentation,
                activityUtils, viewFetcher, sleeper);
        this.dialogUtils = new DialogUtils(instrumentation, activityUtils,
                viewFetcher, sleeper);
        this.webUtils = new WebUtils(config, instrumentation, viewFetcher,
                sleeper);
        this.scroller = new Scroller(config, instrumentation, viewFetcher,
                sleeper);
        this.searcher = new Searcher(viewFetcher, webUtils, scroller, sleeper);
        this.waiter = new Waiter(instrumentation, activityUtils, viewFetcher,
                searcher, scroller, sleeper);
        this.getter = new Getter(instrumentation, activityUtils, waiter);
        this.clicker = new Clicker(activityUtils, viewFetcher, sender,
                instrumentation, sleeper, waiter, webUtils, dialogUtils);
        ...
        this.presser = new Presser(viewFetcher, clicker, instrumentation,
                sleeper, waiter, dialogUtils);
    ...
    public static class Config
    {
         ...
         */
        public String screenshotSavePath = Environment
                .getExternalStorageDirectory() + "/Robotium-Screenshots/";
            ...
            long timeout)
    {
        ...
        {
            Log.d(config.commandLoggingTag, "waitForText(\"" + text + "\", "
                    + minimumNumberOfMatches + ", " + timeout + ")");
        }

        return (waiter.waitForText(text, minimumNumberOfMatches,
                timeout) != null);
    }
            ...
            long timeout, boolean scroll)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "waitForText(\"" + text + "\", " + minimumNumberOfMatches
                            + ", " + timeout + ", " + scroll + ")");
        }
            ...
            boolean scroll)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "waitForView(" + id + ", " + minimumNumberOfMatches + ", "
                            + timeout + ", " + scroll + ")");
        }
    ...
    public boolean waitForView(Object tag, int minimumNumberOfMatches,
            int timeout)
    {
        if (config.commandLogging)
        {
            ...
            int timeout, boolean scroll)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "waitForView(" + tag + ", " + minimumNumberOfMatches + ", "
                            + timeout + ", " + scroll + ")");
        }
    ...
    public <T extends View> boolean waitForView(final Class<T> viewClass)
    {
        ...
        return waiter.waitForView(viewClass, 0, Timeout.getLargeTimeout(),
                true);
    }
    ...
    public <T extends View> boolean waitForView(View view, int timeout,
            boolean scroll)
    {
        if (config.commandLogging)
        {
        ...
        View viewToWaitFor = waiter.waitForView(view, timeout, scroll,
                checkIsShown);
    ...
    public <T extends View> boolean waitForView(final Class<T> viewClass,
            final int minimumNumberOfMatches, final int timeout)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "waitForView(" + viewClass + ", "
            ...
            final boolean scroll)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "waitForView(" + viewClass + ", " + minimumNumberOfMatches
                            + ", " + timeout + ", " + scroll + ")");
        }
    ...
    public boolean waitForWebElement(By by)
    {
        ...
        return (waiter.waitForWebElement(by, 0, Timeout.getLargeTimeout(),
                true) != null);
    }
    ...
    public boolean waitForWebElement(By by, int minimumNumberOfMatches,
            int timeout, boolean scroll)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag,
                    "waitForWebElement(" + by + ", " + minimumNumberOfMatches
                            + "," + timeout + ", " + scroll + ")");
        }

        return (waiter.waitForWebElement(by, minimumNumberOfMatches, timeout,
                scroll) != null);
    }
    ...
    public boolean searchEditText(String text)
    {
        ...
        return searcher.searchWithTimeoutFor(EditText.class, text, 1, true,
                false);
    }
    ...
    public boolean searchButton(String text)
    {
        ...
        return searcher.searchWithTimeoutFor(Button.class, text, 0, true,
                false);
    }
    ...
    public boolean searchToggleButton(String text)
    {
        ...
        return searcher.searchWithTimeoutFor(ToggleButton.class, text, 0, true,
                false);
    }
    ...
    public boolean searchButton(String text, int minimumNumberOfMatches)
    {
        ...
        return searcher.searchWithTimeoutFor(Button.class, text,
                minimumNumberOfMatches, true, false);
    }
            ...
            boolean onlyVisible)
    {
        ...
        {
            Log.d(config.commandLoggingTag, "searchButton(\"" + text + "\", "
                    + minimumNumberOfMatches + ", " + onlyVisible + ")");
        }

        return searcher.searchWithTimeoutFor(Button.class, text,
                minimumNumberOfMatches, true, onlyVisible);
    }
    ...
    public boolean searchToggleButton(String text, int minimumNumberOfMatches)
    {
        ...
        return searcher.searchWithTimeoutFor(ToggleButton.class, text,
                minimumNumberOfMatches, true, false);
    }
    ...
    public boolean searchText(String text)
    {
        ...
        return searcher.searchWithTimeoutFor(TextView.class, text, 0, true,
                false);
    }
    ...
    public boolean searchText(String text, int minimumNumberOfMatches)
    {
        ...
        return searcher.searchWithTimeoutFor(TextView.class, text,
                minimumNumberOfMatches, true, false);
    }
            ...
            boolean scroll)
    {
        ...
        {
            Log.d(config.commandLoggingTag, "searchText(\"" + text + "\", "
                    + minimumNumberOfMatches + ", " + scroll + ")");
        }

        return searcher.searchWithTimeoutFor(TextView.class, text,
                minimumNumberOfMatches, scroll, false);
    }
            ...
            boolean scroll, boolean onlyVisible)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "searchText(\"" + text + "\", " + minimumNumberOfMatches
                            + ", " + scroll + ", " + onlyVisible + ")");
        }

        return searcher.searchWithTimeoutFor(TextView.class, text,
                minimumNumberOfMatches, scroll, onlyVisible);
    }
    ...
    public void assertCurrentActivity(String message, String name)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "assertCurrentActivity(\"" + message
                    + "\", \"" + name + "\")");
        }
    ...
    public void clickOnWebElement(WebElement webElement)
    {
        ...
        clicker.clickOnScreen(webElement.getLocationX(),
                webElement.getLocationY(), null);
    }
    ...
    public void pressMenuItem(int index, int itemsPerRow)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "pressMenuItem(" + index + ", " + itemsPerRow + ")");
        }
    ...
    public void pressSpinnerItem(int spinnerIndex, int itemIndex)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "pressSpinnerItem(" + spinnerIndex
                    + ", " + itemIndex + ")");
        }
    ...
    public void clickLongOnTextAndPress(String text, int index)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "clickLongOnTextAndPress(\"" + text + "\", " + index + ")");
        }
            ...
            int recyclerViewIndex)
    {
        ...
        return clicker.clickInRecyclerView(itemIndex, recyclerViewIndex, 0,
                false, 0);
    }
    ...
    public void clickInRecyclerView(int itemIndex, int recyclerViewIndex,
            int id)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "clickInRecyclerView(" + itemIndex
                    + ", " + recyclerViewIndex + ", " + id + ")");
        }
    ...
    public ArrayList<TextView> clickLongInRecycleView(int itemIndex)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "clickLongInRecycleView(" + itemIndex + ")");
        }
            ...
            int recyclerViewIndex)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "clickLongInRecycleView("
    ...
    public ArrayList<TextView> clickLongInRecycleView(int itemIndex,
            int recyclerViewIndex, int time)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "clickLongInRecycleView("
                    + itemIndex + ", " + recyclerViewIndex + ", " + time + ")");
        }
    ...
    */
            ...
            int stepCount)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "drag(" + fromX + ", " + toX + ", "
                    + fromY + ", " + toY + ")");
        }
    ...
    public boolean scrollDown()
    {
        ...
        {
            waiter.waitForViews(true, AbsListView.class, ScrollView.class,
                    WebView.class, recyclerView.getClass());
        }
        else
        {
            waiter.waitForViews(true, AbsListView.class, ScrollView.class,
    ...
    public boolean scrollDownList(int index)
    {
        ...
        return scroller.scrollList(
                waiter.waitForAndGetView(index, ListView.class), Scroller.DOWN,
                false);
    }
    ...
    public boolean scrollUpList(int index)
    {
        ...
        return scroller.scrollList(
                waiter.waitForAndGetView(index, ListView.class), Scroller.UP,
                false);
    }
    ...
    public void scrollListToLine(AbsListView absListView, int line)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "scrollListToLine(" + absListView + ", " + line + ")");
        }
    ...
    public void scrollListToLine(int index, int line)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "scrollListToLine(" + index + ", " + line + ")");
        }

        scroller.scrollListToLine(
                waiter.waitForAndGetView(index, AbsListView.class), line);
    }
    ...
    public boolean scrollDownRecyclerView(int index)
    {
        ...
        View recyclerView = viewFetcher.getRecyclerView(index,
    ...
    public boolean scrollRecyclerViewToBottom(int index)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "scrollRecyclerViewToBottom(" + index + ")");
        }
            ...
            int stepCount)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "scrollViewToSide(" + view + ", "
                    + side + ", " + scrollPosition + ", " + stepCount + ")");
        }
    ...
    public void pinchToZoom(PointF startPoint1, PointF startPoint2,
            PointF endPoint1, PointF endPoint2)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "pinchToZoom(" + startPoint1 + ", "
        ...
        {
            throw new RuntimeException(
                    "pinchToZoom() requires API level >= 14");
        }
        zoomer.generateZoomGesture(startPoint1, startPoint2, endPoint1,
                endPoint2);
    }
            ...
            PointF endPoint2)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "swipe(" + startPoint1 + ", "
                    + startPoint2 + ", " + endPoint1 + ", " + endPoint2 + ")");
        }
    ...
    public void rotateLarge(PointF center1, PointF center2)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "rotateLarge(" + center1 + ", " + center2 + ")");
        }

        if (android.os.Build.VERSION.SDK_INT < 14)
        {
            throw new RuntimeException(
                    "rotateLarge(PointF center1, PointF center2) requires API level >= 14");
        }
    ...
    public void rotateSmall(PointF center1, PointF center2)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "rotateSmall(" + center1 + ", " + center2 + ")");
        }

        if (android.os.Build.VERSION.SDK_INT < 14)
        {
            throw new RuntimeException(
                    "rotateSmall(PointF center1, PointF center2) requires API level >= 14");
        }
            ...
            int dayOfMonth)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "setDatePicker(" + index + ", "
                    + year + ", " + monthOfYear + ", " + dayOfMonth + ")");
        }

        setDatePicker(waiter.waitForAndGetView(index, DatePicker.class), year,
            ...
            int dayOfMonth)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "setDatePicker(" + datePicker + ", "
                    + year + ", " + monthOfYear + ", " + dayOfMonth + ")");
        }

        datePicker = (DatePicker) waiter.waitForView(datePicker,
                Timeout.getSmallTimeout());
    ...
    public void setTimePicker(int index, int hour, int minute)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "setTimePicker(" + index + ", "
                    + hour + ", " + minute + ")");
        }

        setTimePicker(waiter.waitForAndGetView(index, TimePicker.class), hour,
                minute);
    }
    ...
    public void setTimePicker(TimePicker timePicker, int hour, int minute)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "setTimePicker(" + timePicker + ", "
                    + hour + ", " + minute + ")");
        }

        timePicker = (TimePicker) waiter.waitForView(timePicker,
                Timeout.getSmallTimeout());
    ...
    public void setProgressBar(int index, int progress)
    {
        ...
        setProgressBar(waiter.waitForAndGetView(index, ProgressBar.class),
                progress);
    }
    ...
    public void setProgressBar(ProgressBar progressBar, int progress)
    {
        ...
        progressBar = (ProgressBar) waiter.waitForView(progressBar,
                Timeout.getSmallTimeout());
    ...
    public void setSlidingDrawer(int index, int status)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "setSlidingDrawer(" + index + ", " + status + ")");
        }

        setSlidingDrawer(waiter.waitForAndGetView(index, SlidingDrawer.class),
                status);
    }
    ...
    public void setSlidingDrawer(SlidingDrawer slidingDrawer, int status)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "setSlidingDrawer(" + slidingDrawer + ", " + status + ")");
        }

        slidingDrawer = (SlidingDrawer) waiter.waitForView(slidingDrawer,
                Timeout.getSmallTimeout());
    ...
    public void enterText(EditText editText, String text)
    {
        ...
        editText = (EditText) waiter.waitForView(editText,
                Timeout.getSmallTimeout());
    ...
    public void enterTextInWebElement(By by, String text)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "enterTextInWebElement(" + by + ", \"" + text + "\")");
        }

        if (waiter.waitForWebElement(by, 0, Timeout.getSmallTimeout(),
                false) == null)
        {
            Assert.fail("WebElement with "
                    + webUtils
                            .splitNameByUpperCase(by.getClass().getSimpleName())
                    + ": '" + by.getValue() + "' is not found!");
        }
    ...
    public void typeText(int index, String text)
    {
        ...
        textEnterer.typeText(waiter.waitForAndGetView(index, EditText.class),
                text);
    }
    ...
    public void typeTextInWebElement(By by, String text, int match)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "typeTextInWebElement(" + by
                    + ", \"" + text + "\", " + match + ")");
        }
    ...
    public void typeTextInWebElement(WebElement webElement, String text)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "typeTextInWebElement(" + webElement
                    + ", \"" + text + "\")");
        }
    ...
    public View getView(int id, int index)
    {
        ...
        if (viewToReturn == null)
        {
            ...
            try
            {
                resourceName = instrumentation.getTargetContext().getResources()
                        .getResourceEntryName(id);
            }
            catch (Exception e)
            {
                Log.d(config.commandLoggingTag,
                        "unable to get resource entry name for (" + id + ")");
            }
            ...
            {
                Assert.fail(
                        match + " Views with id: '" + id + "', resource name: '"
                                + resourceName + "' are not found!");
            }
            else
            {
                Assert.fail("View with id: '" + id + "', resource name: '"
    ...
    public View getView(Object tag, int index)
    {
        ...
        if (viewToReturn == null)
        {
            ...
            {
                Assert.fail(
                        match + " Views with id: '" + tag + "' are not found!");
            }
            else
            {
    ...
    public View getView(String id, int index)
    {
        ...
        if (viewToReturn == null)
        {
            ...
            {
                Assert.fail(
                        match + " Views with id: '" + id + "' are not found!");
            }
            else
            {
    ...
    public WebElement getWebElement(By by, int index)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "getWebElement(" + by + ", " + index + ")");
        }

        int match = index + 1;
        WebElement webElement = waiter.waitForWebElement(by, match,
                Timeout.getSmallTimeout(), true);

        if (webElement == null)
        {
            if (match > 1)
            {
                Assert.fail(match + " WebElements with "
                        + webUtils.splitNameByUpperCase(
                                by.getClass().getSimpleName())
                        + ": '" + by.getValue() + "' are not found!");
            }
            else
            {
                Assert.fail("WebElement with "
    ...
    public <T extends View> ArrayList<T> getCurrentViews(
            Class<T> classToFilterBy, boolean includeSubclasses)
    {
        if (config.commandLogging)
        {
            ...
            Class<T> classToFilterBy, View parent)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "getCurrentViews(" + classToFilterBy + ", " + parent + ")");
        }
     ...
     */
    public <T extends View> ArrayList<T> getCurrentViews(
            Class<T> classToFilterBy, boolean includeSubclasses, View parent)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag, "getCurrentViews(" + classToFilterBy
                    + ", " + includeSubclasses + ", " + parent + ")");
        }
    ...
    public boolean isTextChecked(String text)
    {
        ...
        if (viewFetcher.getCurrentViews(CheckedTextView.class, true).size() > 0
                && checker.isCheckedTextChecked(text))
            return true;

        if (viewFetcher.getCurrentViews(CompoundButton.class, true).size() > 0
                && checker.isButtonChecked(CompoundButton.class, text))
            return true;
    ...
    public boolean isSpinnerTextSelected(int index, String text)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "isSpinnerTextSelected(" + index + ",\"" + text + "\")");
        }
    ...
    public boolean waitForEmptyActivityStack(int timeout)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "waitForEmptyActivityStack(" + timeout + ")");
        }
    ...
    public boolean waitForFragmentByTag(String tag, int timeout)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "waitForFragmentByTag(\"" + tag + "\", " + timeout + ")");
        }
    ...
    public boolean waitForFragmentById(int id, int timeout)
    {
        ...
        {
            Log.d(config.commandLoggingTag,
                    "waitForFragmentById(" + id + ", " + timeout + ")");
        }
    ...
    public void startScreenshotSequence(String name)
    {
        ...
        startScreenshotSequence(name, 80, // quality
    ...
    public void startScreenshotSequence(String name, int quality,
            int frameDelay, int maxFrames)
    {
        if (config.commandLogging)
        {
            Log.d(config.commandLoggingTag,
                    "startScreenshotSequence(\"" + name + "\", " + quality
                            + ", " + frameDelay + ", " + maxFrames + ")");
        }
    ...
    private void initialize()
    {
        ...
        Timeout.setLargeTimeout(
                initializeTimeout("solo_large_timeout", config.timeout_large));
        Timeout.setSmallTimeout(
                initializeTimeout("solo_small_timeout", config.timeout_small));
    }
