...
class Scroller
{
    ...
    public Scroller(Config config, Instrumentation inst,
    ...
    public boolean scroll(int direction, boolean allTheWay)
    {
        ...
        ArrayList<View> views = RobotiumUtils.filterViewsToSet(
                new Class[] { ListView.class, ScrollView.class, GridView.class,
                        WebView.class },
                viewList);
    ...
    public boolean scrollWebView(final WebView webView, int direction,
            final boolean allTheWay)
    {
    ...
    public <T extends AbsListView> boolean scrollList(T absListView,
            int direction, boolean allTheWay)
    {
    ...
    public <T extends AbsListView> void scrollListToLine(final T view,
            final int line)
    {
        if (view == null)
    ...
    {
        WindowManager windowManager = (WindowManager) inst.getTargetContext()
