...
class Asserter
{
            ...
            Class<? extends Activity> expectedClass)
    {
        ...
        if (!foundActivity)
        {
            ...
            if (activity != null)
            {
                Assert.assertEquals(message, expectedClass.getName(),
            ...
            Class<? extends Activity> expectedClass, boolean isNewInstance)
    {
        ...
        for (int i = 0; i < activityUtils.getAllOpenedActivities().size()
                - 1; i++)
        {
            String instanceString = activityUtils.getAllOpenedActivities()
                    .get(i).toString();
    ...
    public void assertMemoryNotLow()
    {
        ...
        ((ActivityManager) activityUtils.getCurrentActivity()
