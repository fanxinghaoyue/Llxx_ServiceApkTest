...
class WebElementCreator
{
    ...
    public void createWebElementAndAddInList(String webData, WebView webView)
    {
        ...
        WebElement webElement = createWebElementAndSetLocation(webData,
                webView);
    ...
    private void setLocation(WebElement webElement, WebView webView, int x,
            int y, int width, int height)
    {
        ...
        int locationX = (int) (locationOfWebViewXY[0]
                + (x + (Math.floor(width / 2))) * scale);
        int locationY = (int) (locationOfWebViewXY[1]
    ...
    private WebElement createWebElementAndSetLocation(String information,
            WebView webView)
    {
        ...
        try
        {
            webElement = new WebElement(data[0], data[1], data[2], data[3],
                    data[4], attributes);
