...
public class SystemUtils
{
    ...
    {
        ConnectivityManager dataManager = (ConnectivityManager) instrumentation
                .getTargetContext()
        ...
        try
        {
            dataClass = ConnectivityManager.class
    ...
    {
        WifiManager wifiManager = (WifiManager) instrumentation
