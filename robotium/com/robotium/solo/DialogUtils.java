...
class DialogUtils
{
    ...
    public DialogUtils(Instrumentation instrumentation,
    ...
    private boolean isDialog(Activity activity, View decorView)
    {
        ...
        return (activityContext.equals(viewContext)
                || activityBaseContext.equals(viewContext))
            ...
            boolean shouldSleepAfter)
    {
        ...
        if (activity == null)
        {
            inputMethodManager = (InputMethodManager) instrumentation
                    .getTargetContext()
        ...
        {
            EditText freshestEditText = viewFetcher.getFreshestView(
                    viewFetcher.getCurrentViews(EditText.class, true));
