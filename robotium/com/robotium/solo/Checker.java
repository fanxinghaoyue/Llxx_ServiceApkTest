...
class Checker
{
    ...
    public <T extends CompoundButton> boolean isButtonChecked(
            Class<T> expectedClass, int index)
    {
    ...
    public <T extends CompoundButton> boolean isButtonChecked(
            Class<T> expectedClass, String text)
    {
        T button = waiter.waitForText(expectedClass, text, 0,
    ...
    {
        CheckedTextView checkedTextView = waiter.waitForText(
                CheckedTextView.class, text, 0, Timeout.getSmallTimeout(),
                true);
    ...
    public boolean isSpinnerTextSelected(String text)
    {
        ...
        ArrayList<Spinner> spinnerList = viewFetcher
                .getCurrentViews(Spinner.class, true);
